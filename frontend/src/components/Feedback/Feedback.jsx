  ...
  return (
    <>
      <div className='mb-[50px]'>
        <h4 className='text-[20px] leading-[30px] font-bold text-headingColor mb-[30px]'>All reviews (62)</h4>
        <div className='flex justify-between gap-10 mb-[30px]'>
          <div className='flex gap-3'>
            ...
            <div>
              <h5 className='text-[16px] leading-6 text-primaryColor font-bold'>Milind Nair</h5>
              <p className="text-[14px] leading-6 text-textColor">{formatDate('02-14-2023')}</p>
              <p className="text__para mt-3 font-medium text-[15px]">
                Good services , highly reccommended 👍
              </p>
            </div>
          </div>
