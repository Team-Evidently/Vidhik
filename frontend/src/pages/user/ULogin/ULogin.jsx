...
const ULogin = () => {
  ...
  const handleLogin = (e) => {
    ...
    // If login is successful, show the snackbar and redirect
    setOpenSnackbar(true);

    // You can use the react-router-dom history to redirect the user
    // Replace '/clientdashboard' with the actual URL of your client dashboard
